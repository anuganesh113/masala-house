				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							...
							<h3 class="m-portlet__head-text">Edit Popup</h3>
						</div>
					</div>
						...
						<div class="form-group m-form__group row">
							<div class="col-lg-6">
								...
								<input type="text"
                                       ...
                                       placeholder="Name"
                                       value="{{ old('name')??data_get($popup, "name") }}">
							</div>
							<div class="col-lg-6">
								...
								<input type="text"
                                       ...
                                       class="form-control m-input"
                                       placeholder="Title"
                                       value="{{ old('title')??data_get($popup, "title") }}">
							</div>
						</div>

						<x-admin.image-field :data="['path'=>App\Enums\UploadFilePath::POPUPS_PATH, 'value'=>data_get($popup, 'image')]" />

						<div class="form-group m-form__group">
                            <label>Description</label>
                            <textarea class="tinymce form-control m-input"
                                      name="description"
                                      rows="15">{{ old('description')??data_get($popup, 'description') }}</textarea>
                        </div>
							...
							<div class="col-lg-8">
								...
								<div class="m-input-icon m-input-icon--right">
									<input type="text"
                                           ...
                                           value="{{ old('link')??data_get($popup, "link") }}">
								</div>
							</div>
               
                            <div class="col-lg-2">
                                <x-admin.radio-status :data="['value' => data_get($popup, 'status')]" />
                            </div>
						</div>
