                                    ...
                                    <div class="menuFlex__card">
                                        ...
                                        <div class="contents">
                                            <div class="menuFlex__card--title">
                                              ...
                                              <span class="cat text-white  bt-fr mobdnone {{cssnonveg( $item->type )}}" style="margin-left: 10px;">{{ checkVegetarian($item->type) }}</span>
                                            ...
                                            <div class="popular_cont">
                                               ...
                                               <div class="d-lg-none"> 
                                                <span class="cat text-white {{cssnonveg( $item->type )}}" >{{ checkVegetarian($item->type) }}</span>
                                               ...
                                               <a class="order-btn wtc menuviewbtn mt-2 viewip" href="{{ route('product.old', ['id' => $item->id]) }}"  target="" style="float: inline-end;"><i class="fas fa-search"></i> View Details </a>
