@extends('site.layouts.layout',[
    'title' =>   data_get($page, "title") ?? 'Menu',
    'seotitle' =>   data_get($page, "seo.title") ?? 'Menu',
    ...
    <div class="menu__list" id="menuNav{{ $loop->iteration }}" class="sectionsmenu">
        ...
        <div class="container-fluid">
            <div class="menu__list--box deskview">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="image d-none d-lg-block" style="margin-top: 30%;position: sticky;z-index: 1;top: 100px;">
                                ...
                                <div class="item">
                                    ...
                                    <div class="menuFlex__card dnone menuboxshadow">
                                        <div class="menuFlex__card--img  mobile-menu mb-2 menuimgrespo">
                                            <a href="{{ route('product.old', ['id' => $menu->id]) }}" >
