...
@section("page_title", "Edit Advertise")
            ...
            <div class="col-lg-12">
                <div class="m-portlet">
                    ...
                    <div class="m-portlet__head">
                        <div class="m-portlet__head-caption">
							...
							<span class="m-portlet__head-icon m--hide">
                                ...
                                <h3 class="m-portlet__head-text">Edit Advertise</h3>
                            </div>
                        </div>
                    ...
                    <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                          action="{{ route('admin.advertises.update', $advertise) }}"
                        ...
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text"
                                           ...
                                           value="{{ old('name') ?? data_get($advertise, "name") }}">
                                </div>
                                <div class="col-lg-6">
                                    <label>Link</label>
                                    <div class="m-input-icon m-input-icon--right">
                                        <input type="text"
                                               ...
                                               value="{{ old('link') ?? data_get($advertise, "link") }}">
                                    </div>
                                </div>
                            </div>

                            <x-admin.image-field :data="['path'=>App\Enums\UploadFilePath::ADVERTISES_PATH, 'value'=>data_get($advertise, 'image')]" />
                            ...
                            <div class="form-group m-form__group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="m-input-icon m-input-icon--right">
                                        <input type="number"
                                               ...
                                               class="form-control m-input"
                                               placeholder="Order"
                                               value="{{ old('order')??data_get($advertise, "order") }}">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                        ...
                                        @foreach(App\Enums\AdvertiseType::getValues() as $type)
                                            <label class="m-checkbox m-checkbox--bold m-checkbox--state-primary">
                                                <input type="radio"
                                                       name="type"
                                                       value="{{ $type }}"
                                                    @checked($type === data_get($advertise, 'type'))
                                                >
                                                {{ ucwords($type) }}
                                                <span></span>
                                            </label>
                                ...
                                <div class="col-lg-3">
                                    <x-admin.radio-status :data="['value' => data_get($advertise, 'status')]" />
                                </div>
                            </div>
